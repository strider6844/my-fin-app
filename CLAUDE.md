...
FP&A reporting app that ingests trial-balance exports from a watched folder, computes management P&L variances, drafts commentary, and lets finance edit and publish board-ready reports — no Excel, no local file juggling.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "203758942+strider6844@users.noreply.github.com"
  git config user.name "strider6844"
  ```
